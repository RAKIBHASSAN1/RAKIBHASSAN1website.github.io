<?php	
	...
	if(isset($_POST['save'])){
        ...
        $row = $n1->fetch_array();
        $us=$row['username'];
        $mysqli->query("INSERT INTO sell1(username,product_id,product_type,product_image,product_model,product_price)VALUES('$us','$a','$b','$file','$d','$e')");
    ...
    <body> 
        ...
        <form action="sellproduct1.php" method="post" enctype="multipart/form-data">
            ...
            <div class="button">
                    ...
                    <a href="after_login.php" id="j2" name="save1">Back</a>
