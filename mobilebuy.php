...
$a=$b="";
 $product_quantity_err = "";
	if(isset($_POST['save'])){
        ...
        $row = $n1->fetch_array();
        $us=$row['username'];
        $mysqli->query("INSERT INTO buy(username,product_id,product_quantity)  VALUES('$us','$a','$b')");
            ...
            <?php 
                ...
                if($result = $mysqli->query($sql)){
                    ...
                    while($row = $result->fetch_array()){
                        echo "<form style='margin-left:400px;background-color:green;color:white;width:400px;height:430px;'action='mobilebuy.php'method='post'>";
