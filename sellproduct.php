<?php	
	...
	$a = $b= $c = $d =$e="";
	$name_err = $address_err = $phone_number_err = $email_err =$product_id_err= "";
	if(isset($_POST['save'])){
        $a=$_POST['name'];
        $b=$_POST['address'];
        ...
        $d=$_POST['email'];
        $e=$_POST['product_id'];
        $n1=$mysqli->query("SELECT username FROM user1 where id='1'");
        $row = $n1->fetch_array();
        $us=$row['username'];
        $mysqli->query("INSERT INTO sell(username,name,address,phone_number,email,product_id)VALUES('$us','$a','$b','$c','$d','$e')");
    ...
    <body> 
        ...
        <form action="sellproduct.php" method="post">
            ...
            <div class="n9">
                ...
                <input type="text" id="product_id" name="product_id"  placeholder="Enter Product Id" required="" value="<?php echo $e; ?>">   
